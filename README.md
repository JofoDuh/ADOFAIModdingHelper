# ADOFAI Modding Helper - Multi Mods
Unity package made for ADOFAI mod developers derived from [ADOFAI-Modding-Toolkit](https://github.com/ADOFAI-gg/ADOFAI-Modding-Toolkit). This package streamlines some process in mod development. This branch supports creation/management of multiple mods in the same Unity Project.
***
## Overview
...
***
## Other Detail
- If you don't want to be able to make/manage multiple mods within the same Unity Project, then refer to the [Main Branch](https://github.com/JofoDuh/ADOFAIModdingHelper/).
***
## Setup
1. Install ADOFAI Modding Helper
     ...
     * Then paste `https://github.com/JofoDuh/ADOFAIModdingHelper.git#MultiMods` into the field and click add afterwards.
2. Import ADOFAI
